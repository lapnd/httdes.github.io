...
Smae procedure as [III. b)](#iii-b-debug-briey-soc-with-verilator--openocd--gdb) with three separated terminals, just replace the GDB-terminal step with this Eclipse step.
...
The link included various example bare-metal projects (Quartus + Eclipse) for many FPGA boards.
