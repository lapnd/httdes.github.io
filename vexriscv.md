...
## II. a) Debug Briey SoC with Verilator + OpenOCD + GDB
...
To debug the Briey SoC with Verilator + OpenOCD + GDB:
	...
	$ sbt "runMain vexriscv.demo.Briey"	#make sure that Briey is generated
	$ cd src/test/cpp/briey/
	$ make clean run
	
	Keep the Verilator terminal running, open a second terminal:
