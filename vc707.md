...
To import the freedom folder to the **Idea IntelliJ** tool:
 ...
 - **Big note:** when 'make verilog', please notice that there will be one line looks like this, you should copy it for later use: (the content may be differ on your machine)
 ```
