...
**Git clone:**
	...
	$ cd freedom/
	$ git checkout keystone-fpga		#commit 7f850f07 on 9-Oct-2019
...
Using the Olimex debugger. Ref [link](https://www.olimex.com/Products/ARM/JTAG/ARM-USB-TINY-H/).
...
Copy this [file](./openocd.config) to your **riscv-openocd/** folder. Then:

	$ cd to your riscv-openocd/ folder
	$ openocd -f openocd.cfg
	The GDB debug terminal should appear after this step
...
Some useful tips for debugging the RISC-V CPU:
	...
	Print cpu info:		$ threads info
	Select core:		$ thread i	# i is the core number
	Set program counter:	$ set $pc=...
	Print registers table:	$ registers info
