...
To import the freedom folder to the **Idea IntelliJ** tool:
 ...
 - **Big note:** when 'make verilog', please notice that there will be one line looks like this: (the content may be different on your machine, but please copy this line to somewhere else, it will be useful later)
 ```
